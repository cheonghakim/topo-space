<template>
  <aside v-if="space" class="panel">
    ...
    <div class="panel-body">
      ...
      <section v-if="ui.mode === 'edit' && space.size" class="section">
...
const space = computed(() =>
  ui.selectedSpaceId ? (editor.spaces.get(ui.selectedSpaceId) ?? null) : null,
);
const deviceCount = computed(() =>
  ui.selectedSpaceId
    ? (editor.devicesBySpace.get(ui.selectedSpaceId)?.length ?? 0)
    : 0,
);
