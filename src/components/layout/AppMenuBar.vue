...
function toggleLayer(t: EdgeType) {
  ui.toggleLinkType(t);
}
...
const menus = computed<Menu[]>(() => [
  ...
  },
  {
    ...
    items: [
      ...
      ...PANELS.map((p) => ({
        ...
        action: () => {
          (ui as any)[p.key] = !(ui as any)[p.key];
        },
      })),
      { separator: true },
      ...
      {
        label: "Particles",
        checked: () => ui.showParticles,
        action: () => {
          ui.showParticles = !ui.showParticles;
        },
      },
      {
        label: "Impact radius",
        checked: () => ui.showBlastRadius,
        action: () => {
          ui.showBlastRadius = !ui.showBlastRadius;
        },
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: "Mode: View",
        checked: () => ui.mode === "view",
        action: () => ui.setMode("view"),
      },
      {
        label: "Mode: Edit",
        checked: () => ui.mode === "edit",
        action: () => ui.setMode("edit"),
      },
    ],
  },
  {
